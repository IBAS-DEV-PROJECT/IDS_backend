package com.example.domain.qna.usecase;
...
import com.example.domain.qna.repository.AnswerRepository;
import com.example.domain.qna.repository.QuestionRepository;
