package com.example.domain.recommending.usecase;

import com.example.domain.recommending.domain.MBTISong;
import com.example.domain.recommending.repository.MBTISongRepository;
import com.example.domain.recommending.dto.MBTISongResponse;
